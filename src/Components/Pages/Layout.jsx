          ...
          <div className="flex h-66 w-full justify-between flex-col mt-8  gap-4">
            ...
            <div>
              ...
              <span className="font-bold">
                You might be tempted to skip it because you’re not building
                games — but give it a chance.
              </span>{" "}
            ...
            <div className="bg-yellow-100  px-5 py-5 border-l-8 border-yellow-200 ">
              ...
              <div>
                ...
                <span className="font-bold">learn by doing.</span> If you prefer
                learning concepts from the ground up, check out our{" "}
                <span className="bg-blue-100">step-by-step guide. </span>You
                might find this tutorial and the guide complementary to each
                other.
              </div>
            </div>
            <div className="flex h-66 w-full justify-between flex-col mt-8  gap-2">
              ...
              <li>
                <span className="bg-blue-100">Setup for the Tutorial</span>will
                give you <span className="font-bold">a starting point </span>to
                follow the tutorial.
              </li>
              <li>
                <span className="bg-blue-100">Overview </span>will teach you{" "}
                <span className="font-bold">the fundamentals</span> of React:
                components, props, and state.
              </li>
              <li>
                <span className="bg-blue-100">Completing the Game</span> will
                teach you{" "}
                <span className="font-bold">the most common techniques </span>in
                React development.
              </li>
              <li>
                <span className="bg-blue-100">Adding Time Travel</span> will
                give you <span className="font-bold">a deeper insight</span>{" "}
